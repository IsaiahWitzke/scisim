...
def create_xml(num_balls):
    ...
    <rigidbody2d_scene>
      ...
      <integrator type="symplectic_euler" dt="0.005"/>
    
      <impact_operator type="gr" CoR="1.0" v_tol="1.0e-9" cache_impulses="0">
        <solver name="solver3" linear_solvers="ma97 ma57 mumps ma27 ma86" max_iters="100" tol="1.0e-6"/>
      </impact_operator>
    ...
    os.makedirs('balls_in_box_solver3', exist_ok=True)
    with open(os.path.join('balls_in_box_solver3',f'{num_balls}.xml'), 'w') as f:
        f.write(result)
