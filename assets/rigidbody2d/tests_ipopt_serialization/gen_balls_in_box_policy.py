...
def create_xml(num_balls):
    ...
    <rigidbody2d_scene>
      ...
      <impact_operator type="gr" CoR="1.0" v_tol="1.0e-9" cache_impulses="0">
        <solver name="policy_iteration" max_iters="100" tol="1.0e-8"/>
      </impact_operator>
    ...
    os.makedirs('balls_in_box_policy', exist_ok=True)
    with open(os.path.join('balls_in_box_policy',f'{num_balls}.xml'), 'w') as f:
        f.write(result)
