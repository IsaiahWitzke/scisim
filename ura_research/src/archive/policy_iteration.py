...
def flow(Q, N, v0, initial_control, max_itrs = 100, m_tol = 1e-09, CoR = 1, use_cg = True):
    ...
    returns a bool/vector tuple: (converged, x, p) where...
    - converged is a bool indicating whether or not the algorithm converged
    - x is the solution to the LCP
    - p is the policy that yielded the solution
    """
