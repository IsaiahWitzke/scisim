...
{
  //
  // Printing matricies & vectors
  //

  void printSparseMatrixJson(SparseMatrixsc m, std::string name, std::ostream& o = std::cout);
  
  void printVectorJson(VectorXs v, std::string name, std::ostream& o = std::cout);
  
  void printBoolJson(bool b, std::string name, std::ostream& o = std::cout);

  void printDoubleJson(double d, std::string name, std::ostream& o = std::cout);
  ...
  double getEndError(const SparseMatrixsc &Q, const VectorXs &x, const VectorXs &b);
  
  double getAbsDiff(VectorXs a, VectorXs b);
  
  double getKineticEnergy(const SparseMatrixsc &M, const VectorXs &v);
